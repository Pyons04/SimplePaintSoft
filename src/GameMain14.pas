...
begin
     ...
     mouse_Y := MouseY();
      ...
      else if MouseClicked(LeftButton) and (mouse_X >= 730) and (mouse_Y <= 809) and (mouse_Y >= 452 ) and (mouse_Y <= 512)then
             begin
               result := ColorLemonChiffon();
             end
      else if MouseClicked(LeftButton) and (mouse_X >= 730) and (mouse_Y <= 809) and (mouse_Y >= 512) and (mouse_Y <= 570)then
             begin
                result := ColorAliceBlue();
             end

      else if MouseClicked(LeftButton) and (mouse_X >= 809) and (mouse_Y <= 881) and (mouse_Y >= 390) and (mouse_Y <= 452)then
             begin
                result := ColorBrightGreen();
             end

      else if MouseClicked(LeftButton) and (mouse_X >= 809) and (mouse_Y <= 881) and (mouse_Y >= 452) and (mouse_Y <= 512)then
             begin
                result := ColorMediumPurple();
             end

       else if MouseClicked(LeftButton) and (mouse_X >= 809) and (mouse_Y <= 881) and (mouse_Y >= 512) and (mouse_Y <= 570)then
             begin
                result := ColorWhite();
             end
      else
